...
""" 
An interactive selection tool for the psf photometry tool. 
Functionally the exact same as psf_photometry.py, but rather than manually inputting data directory in the command line, 
a UI appears to select the path of the reduced frames and frame info files. 
...
if __name__ == '__main__':
    ...
    print(f"RETRHO Data Reduction Pipeline Initiated...\Performing PSF Photometry on Data")
