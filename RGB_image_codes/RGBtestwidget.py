...
# print(f"R_img dtype: {R_img.dtype}")
# print(f"G_img dtype: {G_img.dtype}")
# print(f"B_img dtype: {B_img.dtype}")
...
fig = plt.figure(figsize=(16, 8))  # Increased width for better spacing
